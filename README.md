...
- [Features](#features)  
  ...
  - [Workouts (Add, View, Edit, Delete)](#workouts-(add,-view,-edit,-delete))  
- [Issues](#issues)  
...
/> *Taken on my Galaxy S8*
- Users will see an option to enter an `email address` and `password`. They can select either `sign-in` or `sign-up`.
